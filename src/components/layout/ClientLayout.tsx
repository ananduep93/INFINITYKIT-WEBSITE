...
export default function ClientLayout({ children }: ClientLayoutProps) {
  ...
  const categoriesList = [
    { id: 'ai-tools', name: 'AI Tools', icon: <Sparkles size={16} />, folderKey: 'ai-tools', children: [
      ...
      { name: "AI Audio Background Noise Removal", path: "/ai-tools/noise-removal" },
      ...
      { name: "AI Podcast Summarizer & Chapters", path: "/ai-tools/podcast-summary" },
      ...
      { name: "AI Voice Cleaner & Vocal Booster", path: "/ai-tools/voice-cleaner" },
    ...
    { id: 'utility-tools', name: 'Utilities', icon: <Settings size={16} />, folderKey: 'utility-tools', children: [
      ...
      { name: "Compress Audio Size", path: "/utility-tools/compress-audio" },
      { name: "Convert AAC to MP3 Audio", path: "/utility-tools/aac-to-mp3" },
      { name: "Convert FLAC to MP3 Audio", path: "/utility-tools/flac-to-mp3" },
      { name: "Convert MP4 to MP3 Audio", path: "/utility-tools/mp4-to-mp3" },
      { name: "Convert OGG to MP3 Audio", path: "/utility-tools/ogg-to-mp3" },
      { name: "Convert Text Cases", path: "/utility-tools/caseconverter" },
      { name: "Convert Text to Voice", path: "/utility-tools/texttospeech" },
      { name: "Convert WAV to MP3 Audio", path: "/utility-tools/wav-to-mp3" },
      ...
      { name: "Focus Ambient Noise Mixer", path: "/utility-tools/ambient-noise-player" },
      ...
      { name: "Merge & Join Audio Tracks", path: "/utility-tools/merge-audio" },
      ...
      { name: "Split Audio Tracks", path: "/utility-tools/split-audio" },
      { name: "Trim & Cut Audio Clips", path: "/utility-tools/trim-audio" },
