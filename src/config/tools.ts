...
export const categories: CategoryDefinition[] = [
  {
    ...
    "icon": "🤖",
    "emoji": "🤖",
    "description": "AI chat, writing, image, audio, and PDF assistants."
  },
  {
    "id": "image-tools",
    "name": "Image Tools",
    "icon": "🖼️",
    "emoji": "🖼️",
    "description": "Resize, crop, convert, and edit image formats."
  },
  {
    "id": "pdf-tools",
    "name": "PDF Tools",
    "icon": "📄",
    "emoji": "📄",
    "description": "Merge, split, compress, secure, and convert PDF files."
  },
  {
    "id": "student-tools",
    "name": "Student Tools",
    "icon": "🎓",
    "emoji": "🎓",
    "description": "Math solvers, average calculators, and study helpers."
  },
  {
    "id": "survey-builder",
    "name": "Survey Tools",
    "icon": "📊",
    "emoji": "📊",
    "description": "Create surveys, collect responses, and view analytics."
  },
  {
    "id": "utility-tools",
    "name": "Utilities",
    "icon": "🛠️",
    "emoji": "🛠️",
    "description": "Timers, task lists, expenses, sound mixers, and converters."
  }
];
...
export const tools: ToolDefinition[] = [
  ...
  {
    id: 'trim-audio',
    name: 'Trim & Cut Audio Clips',
    description: 'Cut, trim, and crop audio segments client-side with visual waveform controls.',
    category: 'utility-tools',
    icon: '✂️',
    type: 'custom',
    componentName: 'TrimAudio',
    seoTitle: "Free Audio Cutter & Trimmer — Online Audio Tools | InfinityKit",
    seoDescription: "Crop and trim your MP3, WAV, or AAC audio files client-side. Select precision timestamps with visual waveform range selectors.",
    howToSteps: [
      "Upload your audio file to the trimmer workspace.",
      "Scrub or drag the visual range handles to specify start and end points.",
      "Play the preview to confirm the selected segment.",
      "Click Crop & Trim to download your trimmed track instantly."
    ],
    keyFeatures: [
    ...
    faq: [
      { "question": "Is my audio processed on a server?", "answer": "No. The audio decoding and trimming are executed locally in your browser sandbox using the Web Audio API." },
      { "question": "What audio formats are supported?", "answer": "You can upload MP3, WAV, AAC, FLAC, and OGG formats." }
    ]
  },
  {
    id: 'merge-audio',
    name: 'Merge & Join Audio Tracks',
    description: 'Combine and concatenate multiple audio files sequentially into a single track.',
    category: 'utility-tools',
    icon: '🎵',
    type: 'custom',
    componentName: 'MergeAudio',
    seoTitle: "Free Audio Joiner & Merger — Concatenate Audio Online | InfinityKit",
    seoDescription: "Combine multiple audio files sequentially. Reorder tracks, preview your sequence, and export the combined track client-side.",
    howToSteps: [
      "Upload the audio files you want to merge.",
      "Adjust the sequence order using the up/down arrows.",
      "Add or remove files as needed.",
      "Click Merge to render and download the combined track."
    ],
    keyFeatures: [
    ...
    faq: [
      { "question": "Can I merge different file formats?", "answer": "Yes. Our client-side engine decodes different formats (like MP3 and WAV) into raw PCM and joins them seamlessly." }
    ]
  },
  {
    id: 'split-audio',
    name: 'Split Audio Tracks',
    description: 'Chop and slice a single audio track into multiple individual files.',
    category: 'utility-tools',
    icon: '🪓',
    type: 'custom',
    componentName: 'SplitAudio',
    seoTitle: "Free Audio Splitter — Split Tracks Online | InfinityKit",
    seoDescription: "Split your audio track at custom positions. Add split markers interactively on a visual waveform and download all parts.",
    howToSteps: [
      "Upload the audio file you wish to split.",
      "Scrub the timeline and add split markers at specific timestamps.",
      "Add as many markers as you need.",
      "Click Split Audio to export all segments as individual files."
    ],
    keyFeatures: [
    ...
    faq: [
      { "question": "Is there a limit to how many splits I can make?", "answer": "No. You can add as many split markers as you want to divide your file." }
    ]
  },
  {
    id: 'compress-audio',
    name: 'Compress Audio Size',
    description: 'Reduce the file size of your audio files by downsampling quality and channels.',
    category: 'utility-tools',
    icon: '📉',
    type: 'custom',
    componentName: 'CompressAudio',
    seoTitle: "Free Audio Compressor — Reduce File Size Online | InfinityKit",
    seoDescription: "Compress audio files client-side. Adjust sample rates, downmix stereo to mono, and reduce filesize while preserving audibility.",
    howToSteps: [
      "Upload the audio file you want to compress.",
      "Choose a sample rate preset (CD Quality, Medium, or Low).",
      "Select mono or stereo channel output.",
      "Click Compress & Export to download the optimized file."
    ],
    keyFeatures: [
      "Client-side OfflineAudioContext rendering for ultra-fast compression",
      "Configurable channel downmixing (stereo to mono) for file size savings",
      "Saves bandwidth and device storage",
      "No data limits or privacy leakage"
    ],
    useCases: ["Mobile Users", "Web Developers", "Email Senders"],
    faq: [
      { "question": "How much can I reduce my file size?", "answer": "Converting stereo to mono and choosing a lower sample rate (like 22kHz) can reduce WAV file sizes by over 70%." }
    ]
  },
  {
    id: 'mp4-to-mp3',
    name: 'Convert MP4 to MP3 Audio',
    description: 'Extract high-quality MP3 audio tracks from MP4 video files.',
    category: 'utility-tools',
    icon: '📼',
    type: 'custom',
    componentName: 'MP4ToMP3',
    seoTitle: "Free MP4 to MP3 Converter — Extract Audio Online | InfinityKit",
    seoDescription: "Extract MP3 audio from MP4 videos. Transcode streams using FFmpeg servers for maximum compatibility and speed.",
    howToSteps: [
      "Select and upload your MP4 video file.",
      "Confirm target format is set to MP3.",
      "Click Transcode to run FFmpeg conversion.",
      "Download your high-quality MP3 file."
    ],
    keyFeatures: [
      "Full server-side FFmpeg transcoding engine",
      "Extracts pristine audio streams in seconds",
      "Direct downloads and Supabase library integration",
      "Completely secure and private"
    ],
    useCases: ["Video Editors", "Music Lovers", "Students"],
    faq: [
      { "question": "Does this support large video files?", "answer": "Yes. Files up to 100MB are supported for server-side audio extraction." }
    ]
  },
  {
    id: 'wav-to-mp3',
    name: 'Convert WAV to MP3 Audio',
    description: 'Compress uncompressed WAV audio files into standard MP3 tracks.',
    category: 'utility-tools',
    icon: '💿',
    type: 'custom',
    componentName: 'WAVToMP3',
    seoTitle: "Free WAV to MP3 Converter — Compress WAV Files | InfinityKit",
    seoDescription: "Convert uncompressed WAV files to MP3. Fast transcoding using FFmpeg for optimal bitrate compaction.",
    howToSteps: [
      "Upload your uncompressed WAV file.",
      "Select MP3 as the target format.",
      "Click Transcode to execute compression.",
      "Download the compressed MP3 track."
    ],
    keyFeatures: [
      "Reduces file size by up to 90% using high-grade MP3 coding",
      "Maintains clean audio fidelity at 128kbps+",
      "Saves to your personal audio library dashboard",
      "No software download required"
    ],
    useCases: ["Musicians", "Podcasters", "Office Workers"],
    faq: [
      { "question": "Why convert WAV to MP3?", "answer": "WAV files are raw and take up huge space. MP3 makes sharing and playing much faster." }
    ]
  },
  {
    id: 'aac-to-mp3',
    name: 'Convert AAC to MP3 Audio',
    description: 'Apple AAC (.m4a) audio files to highly compatible MP3 format.',
    category: 'utility-tools',
    icon: '🍎',
    type: 'custom',
    componentName: 'AACToMP3',
    seoTitle: "Free AAC to MP3 Converter — Transcode M4A Online | InfinityKit",
    seoDescription: "Convert Apple AAC/M4A files to MP3 online. Secure transcoding via server-side FFmpeg for broad device compatibility.",
    howToSteps: [
      "Upload your AAC or M4A file.",
      "Select MP3 target format.",
      "Click Transcode to convert audio stream.",
      "Download and share your MP3 file."
    ],
    keyFeatures: [
      "FFmpeg-powered transcode processing for Apple audio streams",
      "Maintains stereo separation and clear acoustics",
      "Stores output to Supabase with simple copy-share links",
      "Unlimited files"
    ],
    useCases: ["iPhone Users", "Audio Techs", "DJ Collectors"],
    faq: [
      { "question": "Can I convert protected M4P files?", "answer": "No. We do not decrypt DRM-protected music files purchased on iTunes." }
    ]
  },
  {
    id: 'flac-to-mp3',
    name: 'Convert FLAC to MP3 Audio',
    description: 'Convert lossless FLAC audio files into standard compact MP3 tracks.',
    category: 'utility-tools',
    icon: '🎼',
    type: 'custom',
    componentName: 'FLACToMP3',
    seoTitle: "Free FLAC to MP3 Converter — Lossless to Lossy Online | InfinityKit",
    seoDescription: "Convert lossless FLAC audio files to compact MP3 files. Streamlined FFmpeg transcoding with bitrate control.",
    howToSteps: [
      "Upload your high-fidelity FLAC audio file.",
      "Set format target to MP3.",
      "Click Transcode to convert file.",
      "Download the compressed MP3 track."
    ],
    keyFeatures: [
      "Compresses high-res lossless files for everyday portable players",
      "Clean high-frequency response retention",
  ...
  {
    id: 'ogg-to-mp3',
    name: 'Convert OGG to MP3 Audio',
    description: 'Convert Ogg Vorbis audio tracks into standard MP3 files.',
    category: 'utility-tools',
    icon: '📻',
    type: 'custom',
    componentName: 'OGGToMP3',
    seoTitle: "Free OGG to MP3 Converter — Transcode Ogg Vorbis | InfinityKit",
    seoDescription: "Transcode OGG audio files to MP3 online. Easy conversion using FFmpeg for optimal audio compatibility.",
    howToSteps: [
      "Upload your OGG Vorbis audio file.",
      "Select MP3 as target format.",
      "Click Transcode to begin.",
    ...
    faq: [
      { "question": "Is OGG better than MP3?", "answer": "OGG offers better compression efficiency at low bitrates, but MP3 enjoys universal support on all platforms and hardware." }
    ]
  },
  {
    id: 'voice-cleaner',
    name: 'AI Voice Cleaner & Vocal Booster',
    description: 'Clean speech voice tracks, boost clarity, and enhance vocals using high-pass filters and equalizers.',
    category: 'ai-tools',
    icon: '🎙️',
    type: 'custom',
    componentName: 'VoiceCleaner',
    seoTitle: "Free Voice Cleaner & Vocal Enhancer Online | InfinityKit",
    seoDescription: "Clean up voice recordings, boost vocal presence, and cut low-end rumble with Web Audio API DSP filters.",
    howToSteps: [
      "Upload your voice recording or voiceover file.",
      "Adjust the Vocal Boost and Rumble filter cutoff sliders.",
      "Toggle bypass to compare the cleaned audio in real-time.",
      "Render and download your enhanced voice file."
    ],
    keyFeatures: [
    ...
    faq: [
      { "question": "Does it require internet?", "answer": "No. The voice cleaning DSP filters run 100% locally in your browser, keeping your voice files private." }
    ]
  },
  {
    id: 'noise-removal',
    name: 'AI Audio Background Noise Removal',
    description: 'Remove background noise, hiss, static hum, and air conditioning noise using dynamics noise gates.',
    category: 'ai-tools',
    icon: '🔇',
    type: 'custom',
    componentName: 'NoiseRemoval',
    seoTitle: "Free Audio Noise Removal Online — Remove Hiss & Static | InfinityKit",
    seoDescription: "Remove static hum, hiss, and ambient noise from audio files. Uses dynamics compressors and threshold gates client-side.",
    howToSteps: [
      "Upload your noisy audio track.",
      "Select Hiss cutoff frequency and Noise Gate threshold.",
      "Listen to the live preview and adjust sliders to mute background silence.",
      "Click Render Clean Audio to download your static-free track."
    ],
    keyFeatures: [
      "Visual peak waveform and realtime audio playback",
      "Noise gate silences background gaps below the selected threshold",
      "Low-pass filter cuts high-pitched hiss, static, and whine",
      "Completely private and local"
    ],
    useCases: ["Interview Editors", "Vloggers", "Audio Engineers"],
    faq: [
      { "question": "What is a noise gate?", "answer": "A noise gate silences audio signals below a certain volume threshold, effectively removing background room noise during quiet segments." }
    ]
  },
  {
    id: 'podcast-summary',
    name: 'AI Podcast Summarizer & Chapters',
    description: 'Transcribe and generate structured summaries, key takeaways, and chapter listings from podcasts.',
    category: 'ai-tools',
    icon: '📝',
    type: 'custom',
    componentName: 'PodcastSummary',
    seoTitle: "Free AI Podcast Summarizer — Extract Transcripts & Outlines | InfinityKit",
    seoDescription: "Summarize podcasts and lectures using AI. Generate clean markdown outlines, key points, and chapter listings.",
    howToSteps: [
      "Upload your podcast or lecture audio file.",
      "Select your preferred AI provider (OpenAI or Gemini).",
      "Enter your API key in Settings if not already configured.",
      "Click Extract Summary to generate structured notes."
    ],
    keyFeatures: [
    ...
    faq: [
      { "question": "How long does summarization take?", "answer": "Processing takes between 30 seconds to 2 minutes depending on file length." }
    ]
  }
];
