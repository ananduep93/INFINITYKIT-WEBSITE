        ...
        <>
          ...
          {trendingTools.length > 0 && (
            <div style={{ marginBottom: '35px' }}>
              <h3 style={{ fontSize: '0.85rem', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '1px', color: 'var(--text-secondary)', marginBottom: '15px', display: 'flex', alignItems: 'center', gap: '6px' }}>
                <span style={{ color: '#EF4444' }}>🔥</span> Popular & Trending
              </h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                {trendingTools.map((tool) => (
                  ...
                  >
                    ...
                    >
                      <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: '20px', minWidth: 0 }}>
