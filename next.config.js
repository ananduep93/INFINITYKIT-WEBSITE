      ...
      // ── HTML pages: short cache with stale-while-revalidate ───────────────
      {
        ...
        headers: [
          ...
          { key: 'Referrer-Policy', value: 'strict-origin-when-cross-origin' },
           ...
           { key: 'Content-Security-Policy', value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://www.gstatic.com https://apis.google.com https://cdn.jsdelivr.net https://cdnjs.cloudflare.com; worker-src 'self' blob: https://cdnjs.cloudflare.com https://cdn.jsdelivr.net; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: blob: https://*.supabase.co https://*.firebasestorage.app https://*.firebaseapp.com https://lh3.googleusercontent.com https://api.qrserver.com https://images.unsplash.com https://text.pollinations.ai https://pollinations.ai https://image.pollinations.ai; font-src 'self' https://fonts.gstatic.com; connect-src 'self' blob: https://cdnjs.cloudflare.com https://cdn.jsdelivr.net https://*.supabase.co https://*.firebaseio.com https://*.googleapis.com https://*.firestore.googleapis.com https://*.firebasestorage.app https://identitytoolkit.googleapis.com https://securetoken.googleapis.com https://api.openai.com https://api.pwnedpasswords.com https://text.pollinations.ai https://image.pollinations.ai https://openrouter.ai https://api.imgbb.com https://api.remove.bg; frame-src 'self' https://*.firebaseapp.com https://*.firebase.com; media-src 'self' blob: data: https://*.firebasestorage.app; object-src 'none'; base-uri 'self'; form-action 'self'; frame-ancestors 'self'; upgrade-insecure-requests;" }
        ],
      },
    ];
  },
