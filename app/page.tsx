  ...
  return (
    <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '10px 24px 60px' }}>
      ...
      <section style={{ 
        ...
        >
          Access over 80+ secure, client-side digital tools for document conversion, visual editing, and advanced AI utilities. Engineered for ultimate client privacy and absolute zero server tracking.
        </motion.p>
