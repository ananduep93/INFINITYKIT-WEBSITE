...
export default function ClientLayout({ children }: ClientLayoutProps) {
  ...
  const categoriesList = [
    { id: 'ai-tools', name: 'AI Tools', icon: <Sparkles size={16} />, folderKey: 'ai-tools', children: [
      ...
      { name: "AI Image Generator", path: "/ai-tools/ai-image-generator" },
      { name: "AI Art Generator", path: "/ai-tools/ai-art-generator" },
      { name: "AI Avatar Generator", path: "/ai-tools/ai-avatar-generator" },
      { name: "AI Headshot Generator", path: "/ai-tools/ai-headshot-generator" },
      { name: "AI Logo Generator", path: "/ai-tools/ai-logo-generator" },
      { name: "AI Wallpaper Generator", path: "/ai-tools/ai-wallpaper-generator" },
